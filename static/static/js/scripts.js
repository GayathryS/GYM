/*------------------------------------------------------------------
 * Website Name: Post It Everywhere
 * App URI: http://inebur.com/Post It Everywhere/template/
 * Author: inebur
 * Author URI: http://inebur.com/
 * Copyright 2019 Post It Everywhere
 * Version: 1.5
 -------------------------------------------------------------------*/
...
//----------------------------------------------------/
function translate(){
    $.getScript('/static/js/lib/i18next.min.js', function() {
        $.getScript('/static/js/lib/i18nextXHRBackend.min.js', function() {
            $.getScript('/static/js/lib/jquery-i18next.min.js', function() {
...
function headerfooter(){
    $("#header").load("static/header.html", function(res, status, xhr){
    ...
    $("#footer").load("static/footer.html", function(res, status, xhr){
        $('#drop-lng [data-lng="' + localStorage.getItem('lng') + '"]').addClass('xpto active');
        $('#drop-lng label').click(function(e){
            e.preventDefault();
            localStorage.setItem('lng', $(this).attr('data-lng'));
